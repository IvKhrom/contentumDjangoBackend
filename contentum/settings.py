...
WSGI_APPLICATION = "contentum.wsgi.application"
...
# Настройки для корректного отображения русских символов
...
REST_FRAMEWORK = {
    ...
    # Настройки для корректной кодировки
